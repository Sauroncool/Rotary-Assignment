...
MR_collective   = pilot_inputs(main_collective) # main rotor collective theta input by pilot
MR_cyclic_a1    = pilot_inputs(main_cyclic_a1)  # main rotor cyclic theta - a1 input
MR_cyclic_a2    = pilot_inputs(main_cyclic_a2)  # main rotor cyclic theta - a2 input
